...
Em algum local onde é possível escrever, digite \\\\macro\\, onde macro == os comandos da coluna esquerda do arquivo master_macro.config. Se estiver lendo fora do github, a ativação do algoritmo demanda duas contrabarras, o nome do macro, e mais uma contrabarra.
